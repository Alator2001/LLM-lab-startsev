...
- ✅ **Отображение актуальных курсов криптовалют** 🆕
...
- `/crypto` - **Показать актуальные курсы криптовалют** 🆕
...
Команда показывает актуальные курсы топ-3 криптовалют:
- Bitcoin (BTC)
- Ethereum (ETH)
- Tether (USDT)

Данные получаются из публичного API CoinGecko.
...
- **Ошибки сети при запросе курсов криптовалют** 🆕
- **Таймауты при обращении к внешним API** 🆕
